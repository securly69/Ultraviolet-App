(() => {
    ...
    function g(o) {
        ...
        a.nativeMethods.defineProperty(e.meta, "base", {
            ...
            parent: i + "parent",
            top: i + "top"
        }, e.filterKeys = [p, e.methods.setSource, e.methods.source, e.methods.location, e.methods.function, e.methods.string, e.methods.eval, e.methods.parent, e.methods.top, i + "protocol", i + "storageObj", i + "url", i + "modifiedStyle", i + "config", i + "dispatched", "Ultraviolet", "__uvHook"], a.on("wrap", (t, r) => {
            ...
            e.attrs.isUrl(t.data.name) && (t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteUrl(t.data.value)), e.attrs.isStyle(t.data.name) && (t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteCSS(t.data.value, {
                ...
                ...e.meta,
                document: !0,
                injectHead: e.createHtmlInject(e.handlerScript, e.bundleScript, e.clientScript, e.configScript, n, o.location.href)
            })), e.attrs.isSrcset(t.data.name) && (t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.html.wrapSrcset(t.data.value.toString())), e.attrs.isForbidden(t.data.name) && (t.data.name = e.attributePrefix + "-attr-" + t.data.name)
        ...
        if (a.element.hookProperty(u, "contentWindow", {
                ...
                if (t.that.__uv$storageObj)
                    for (let r of a.nativeMethods.keys.call(null, t.that.__uv$storageObj)) delete t.that.__uv$storageObj[r], a.storage.removeItem.call(t.that, i + e.meta.url.origin + "@" + r), t.respondWith()
                ...
                if (!l[i + "modifiedStyle"])
                    for (let s of a.style.urlProps) a.nativeMethods.defineProperty(l, s, {
                        ...
                        get() {
                            ...
                            return e.sourceCSS(m, {
                                context: "value",
                                ...e.meta
                            })
                        },
                        set(m) {
                            a.style.setProperty.call(this, a.style.propToDashed[s] || s, e.rewriteCSS(m, {
                                context: "value",
                                ...e.meta
                            }))
                        }
